...
<html lang="en">
  <head>
    ...
    <meta name="description" content="This site is a responsive-demo done with the guidance of
      Jonas Schmedtmann's Udemy course'Build Responsive Real World Websites with HTLM5 and CSS3'">
    ...
    <title>Omnifood (Responsive Demo)</title>
  ...
  <body>
    ...
    <section class="section-features js--section-features" id="features">
      <div class="row">
        ...
        <p class="long-copy">
          Hello, we're Omnifood, your new premium food delivery service. We know you're always busy. No time for cooking. So let us take
      ...
      <div class="row js--wp-1">
        <div class="col span-1-of-4 box">
          ...
          <p>
            Never cook again! We really mean that. Our subscription plans include up to 265 days/year coverage. You can also choose
        ...
        <div class="col span-1-of-4 box">
          ...
          <p>
            You're onle 20 minutes away from your delicious and super healthy meals delivered right to your home. We wore with the
        ...
        <div class="col span-1-of-4 box">
          ...
          <h3>100% organic</h3>
          <p>
            All our vegetables are fresh, organic and local. Animals are raised without hormones or antibiotics. Good for your
      ...
      <ul class="meals-showcase clearfix">
        <li>
          <figure class="meal-photo">
            <img src="resources/css/img/1.jpg" alt="korean bipirpap with egg and vegetable" />
          </figure>
        </li>
        <li>
          <figure class="meal-photo">
            <img src="resources/css/img/2.jpg" alt="Simple Italian pizza with cherry tomaotes" />
          </figure>
        </li>
        <li>
          <figure class="meal-photo">
      ...
      <div class="row">
        ...
        <div class="col span-1-of-2 steps-box">
          <div class="works-step">
            <div>1</div>
            <p>
              Choose the subscription that best fits your needs and sign up today.
            </p>
          </div>
          <div class="works-step">
            <div>2</div>
          ...
          <div class="works-step">
            <div>3</div>
            <p>
              Enjoy your meal after less than 20 minuts. See you next time!
            </p>
          </div>
          <a href="#" class="btn-app"><img src="resources/css/img/download-app.svg" alt="App Store Button"></a>
          <a href="#" class="btn-app"><img src="resources/css/img/download-app-android.png" alt="App Store Button"></a>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          <div class="col span-1-of-3">
            <blockquote>
              ...
              Now that I got used to it,  I couln't live without my daily meals!
              <cite><img src="resources/css/img/customer-1.jpg" alt="customer-1-photo">Alberto Duncan</cite>
            </blockquote>
          </div>
          <div class="col span-1-of-3">
            <blockquote>
              Inexpensive, healthy and great-tasting meals, delivered right to my home. We have lots of food delivery here in Lisbon,
              but no one comes even close to Omnifood. Me and my family are so in love!
              <cite><img src="resources/css/img/customer-2.jpg" alt="customer-2-photo">Joanna Silva</cite>
            </blockquote>
          </div>
          <div class="col span-1-of-3">
            <blockquote>
              I was looking for a quick and easy deliver service in San Francisco. I tried a lot of them and ended up with Omnifood. Best food delivery
              service in the Bay Area. Keep up the great work!
              <cite><img src="resources/css/img/customer-3.jpg" alt="customer-3-photo">Milton Chapman</cite>
            </blockquote>
          </div>
        </div>
      </div>
